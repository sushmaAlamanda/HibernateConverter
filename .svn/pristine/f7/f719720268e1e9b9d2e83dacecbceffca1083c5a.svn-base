...
(function($) { // hide the namespace
	...
	$.keypad.regionalOptions.ca = {
		buttonText: '...',
		buttonStatus: 'Obrir el teclat',
		closeText: 'Tancar',
		closeStatus: 'Tancar el teclat',
		clearText: 'Netejar',
		clearStatus: 'Eliminar tot el text',
		backText: 'Tornar',
		backStatus: 'Borrar el caràcter anterior',
		shiftText: 'Shift',
		shiftStatus: 'Canviar majúscules/minúscules',
		spacebarText: '&nbsp;',
		spacebarStatus: '',
		enterText: 'Entrar',
		enterStatus: '',
